...
module system_mm_interconnect_1 (
	...
	wire          vga_mem_agent_rdata_fifo_src_valid;                                          // vga_mem_agent:rdata_fifo_src_valid -> vga_mem_agent_rdata_fifo:in_valid
	wire    [9:0] vga_mem_agent_rdata_fifo_src_data;                                           // vga_mem_agent:rdata_fifo_src_data -> vga_mem_agent_rdata_fifo:in_data
	wire          vga_mem_agent_rdata_fifo_src_ready;                                          // vga_mem_agent_rdata_fifo:in_ready -> vga_mem_agent:rdata_fifo_src_ready
	wire          vga_mem_agent_rdata_fifo_out_valid;                                          // vga_mem_agent_rdata_fifo:out_valid -> vga_mem_agent:rdata_fifo_sink_valid
	wire    [9:0] vga_mem_agent_rdata_fifo_out_data;                                           // vga_mem_agent_rdata_fifo:out_data -> vga_mem_agent:rdata_fifo_sink_data
	wire          vga_mem_agent_rdata_fifo_out_ready;                                          // vga_mem_agent:rdata_fifo_sink_ready -> vga_mem_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (vga_mem_agent_rdata_fifo_out_ready),          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (vga_mem_agent_rdata_fifo_out_valid),          //                .valid
		.rdata_fifo_sink_data    (vga_mem_agent_rdata_fifo_out_data),           //                .data
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) vga_mem_agent_rdata_fifo (
		.clk               (clk_vga_clk_clk),                            //       clk.clk
		.reset             (vga_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (vga_mem_agent_rdata_fifo_src_data),          //        in.data
		.in_valid          (vga_mem_agent_rdata_fifo_src_valid),         //          .valid
		.in_ready          (vga_mem_agent_rdata_fifo_src_ready),         //          .ready
		.out_data          (vga_mem_agent_rdata_fifo_out_data),          //       out.data
		.out_valid         (vga_mem_agent_rdata_fifo_out_valid),         //          .valid
		.out_ready         (vga_mem_agent_rdata_fifo_out_ready),         //          .ready
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (pc_bus_reset_sink_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (pc_bus_reset_sink_reset_bridge_in_reset_reset), // out_clk_reset.reset
